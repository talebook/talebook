...
settings = {
    ...
    "xsrf_cookies"  : False,
    "static_host"   : "",
    "nuxt_env_path" : os.environ.get("TALEBOOK_NUXT_ENV_PATH", os.path.join(os.path.dirname(__file__), "../app/.env")),
    ...
    "import_mode"   : "copy",
    "import_auto_watch_enabled": False,
    "import_allowed_roots": ["/data/books/imports/"],
    "import_watch_interval_seconds": 30,
    "import_scan_batch_size": 500,
    ...
    "AUDIOBOOK_CACHE_DAYS": 30,
    "AUDIOBOOK_FAILED_TEMP_DAYS": 7,
    "AUDIOBOOK_LEASE_SECONDS": 30,
    "AUDIOBOOK_HEARTBEAT_SECONDS": 3,
    "AUDIOBOOK_CANCEL_TERM_SECONDS": 15,
    ...
    "PODCAST_RATE_LIMIT_REQUESTS": 120,
