    ...
    },
    {
        ...
        fields: [
            ...
            { icon: 'mdi-information', key: 'EPUB_VIEWER', label: t('admin.settings.label.epubViewer'), type: 'select',
                items: [{text: t('admin.settings.option.oldEpubReader'), value: 'epubjs.html'}, {text: t('admin.settings.option.candleReader'), value: 'creader.html'}, {text: t('admin.settings.option.readestReader'), value: 'readest'} ]
            },
...
const HEADER_OFFSET = 156; // app-bar(48) + 路径页签(48) + 悬浮保存栏(约 60)
