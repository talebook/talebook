...
<template>
    <div>
        ...
        <v-dialog v-model="dialog" persistent transition="dialog-bottom-transition" width="400">
            <v-card>
                <v-toolbar flat density="compact" dark color="primary">
                    <v-toolbar-title class="ml-4">上传SSL证书</v-toolbar-title>
                    <v-spacer></v-spacer>
                    <v-btn variant="text" @click="dialog = false">关闭</v-btn>
                </v-toolbar>
                <v-card-text class="pt-4">
                    <p class="mb-4 text-caption">请上传PEM格式的证书文件</p>
                    <v-form ref="form" @submit.prevent="upload_ssl">
