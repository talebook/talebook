"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7605],{97605:(E,T,e)=>{e.d(T,{getMigrations:()=>t});let N={opds:[{name:"2026052701_opds_source_mappings",sql:`
      ...
      `}],"bookorbit-sync":[{name:"2026080401_bookorbit_sync",sql:`
      ...
      `}],"library-search":[{name:"2026080101_library_search_sections",sql:`
