            ...
            <v-col cols="12">
                ...
                <div class="mb-2">
                    <div class="d-flex align-center">
                        ...
                        >
                            <v-chip
                                :color="filters.publisher === '全部' ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.publisher === '全部' ? 'white' : 'black'"
                                label
                                small
                            ...
                            <v-chip
                                ...
                                :key="item.id"
                                :color="filters.publisher === item.name ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.publisher === item.name ? 'white' : 'black'"
                                label
                                small
                ...
                <div class="mb-2">
                    <div class="d-flex align-center">
                        ...
                        >
                            <v-chip
                                :color="filters.author === '全部' ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.author === '全部' ? 'white' : 'black'"
                                label
                                small
                            ...
                            <v-chip
                                ...
                                :key="item.id"
                                :color="filters.author === item.name ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.author === item.name ? 'white' : 'black'"
                                label
                                small
                ...
                <div class="mb-2">
                    <div class="d-flex align-center">
                        ...
                        >
                            <v-chip
                                :color="filters.tag === '全部' ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.tag === '全部' ? 'white' : 'black'"
                                label
                                small
                            ...
                            <v-chip
                                ...
                                :key="item.id"
                                :color="filters.tag === item.name ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.tag === item.name ? 'white' : 'black'"
                                label
                                small
                ...
                <div class="mb-3">
                    <div class="d-flex align-center">
                        ...
                        >
                            <v-chip
                                :color="filters.format === '全部' ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.format === '全部' ? 'white' : 'black'"
                                label
                                small
                            ...
                            <v-chip
                                ...
                                :key="item.id"
                                :color="filters.format === item.name ? 'primary' : 'grey lighten-2'"
                                :text-color="filters.format === item.name ? 'white' : 'black'"
                                label
                                small
