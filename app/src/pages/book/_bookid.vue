        ...
        <v-col cols=12>
            ...
            <v-card v-if="!dialog_refer">
                <v-toolbar flat dense color="white" >
                    ...
                    <v-btn :small="tiny" dark color="primary" class="mx-2 d-flex d-sm-flex"
                            :href="'/read/'+book.id" target="_blank"> <v-icon left v-if="!tiny">import_contacts</v-icon> 阅读</v-btn>
                    ...
                    <v-menu offset-y>
                        ...
                        <v-list>
                            <v-list-item :to="'/book/'+book.id+'/edit'"> <v-icon>settings_applications</v-icon> 编辑书籍信息 </v-list-item>
